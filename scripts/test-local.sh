...
jq -e '.mode == "llmwave-memory-eval" and .version == "v119-qa-answer-eval" and .legacy_version == "v109-generator-quality-eval" and .passed == 9 and .total == 9 and .accuracy == 1' <<<"$memory_eval_json" >/dev/null
