...
jq -e '.claim_boundary.scale_amortized_nonlinear_memory_proven == true and .claim_boundary.nonlinear_memory_proven == false and (.claim_boundary.blocked_by | index("external_corpus_missing") | not) and (.claim_boundary.blocked_by | index("broad_noise_eval_missing") | not) and (.claim_boundary.blocked_by | index("fixed_basis_does_not_beat_linear_baseline"))' <<<"$big_nonlinear_fixture_json" >/dev/null
