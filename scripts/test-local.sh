...
run_chatcore_suite() {
  ...
  chat_core_stale_json="$("$llmwave_big" chat-core-ask --profile examples/linux-chat-core.profile.json --memory-root "$root/.nanda/linux-active" --dialogue-overlay "$tmp_dialogue_overlay" --text "which package provides command bash" --format json)"
