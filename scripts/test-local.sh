...
jq -e '.mode == "unified-field-audit" and .version == "unified-field-pass-v1" and .overall_state == "STRUCTURAL_FIELD_CORE_SOLE_ENGINE_ACTIVE_GLOBAL_NOT_READY" and .acceptance.one_field_pass == true and .acceptance.field_core_as_semantic_engine == true and .acceptance.feedback_memory_delta_unified == true and .acceptance.semantic_equivalence_gate == true and .acceptance.structural_dual_run_active == true and .acceptance.structural_cutover_eval_ready == true and .acceptance.structural_cutover_suite_available == true and .acceptance.structural_cutover_suite_pass == true and .acceptance.structural_field_core_as_sole_engine == true and .families[0].sole_engine == true and .families[1].sole_engine == true and .structural_cutover_suite.suite == "structural-standard" and .structural_cutover_suite.acceptance.cases_checked == 4 and .structural_cutover_suite.acceptance.structural_cutover_suite_pass == true and .acceptance.packed_dual_run_active == true and .acceptance.packed_hot_core_exception == false and .acceptance.packed_field_core_as_sole_engine == true and .acceptance.packed_field_record_view == true and .acceptance.cognitive_dual_run_active == true and .acceptance.unified_lens_contract == true and .acceptance.unified_anti_wave_contract == true and .acceptance.unified_memory_delta_store == true and .acceptance.route_scoped_extraction_required == false and .acceptance.field_core_as_sole_engine == false and .acceptance.llm_ready == false and (.next_required_steps | length) == 0' <<<"$field_audit_json" >/dev/null
jq -e '.field_engine_contract.version == "unified-field-engine-contract-v1" and .field_engine_contract.policy_owner == "field_core::engine::FieldEngineDecision" and .field_engine_contract.families_checked == 3 and .acceptance.three_family_engine_contract == true and .acceptance.field_engine_policy_in_field_core == true and .acceptance.structural_cutover_mode_available == true and .field_engine_contract.structural.cutover_allowed == true and .field_engine_contract.structural.cutover_mode == "default" and .field_engine_contract.structural.structural_sole_engine == true and .field_engine_contract.structural.global_sole_engine == false and .acceptance.packed_field_engine_guard == true and .acceptance.packed_cutover_blocked_by_hot_guard == false and .field_engine_contract.packed.cutover_allowed == true and .field_engine_contract.packed.blocked_by == null and .field_engine_contract.packed.packed_sole_engine == true and .field_engine_contract.packed.global_sole_engine == false and .acceptance.cognitive_field_engine_guard == true and .acceptance.cognitive_cutover_blocked_by_claim_guard == true and .field_engine_contract.cognitive.cutover_allowed == false and .field_engine_contract.cognitive.chat_engine == false and .field_engine_contract.cognitive.llm_ready == false' <<<"$field_audit_json" >/dev/null
