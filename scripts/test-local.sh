...
big_density_ablation_json="$("$llmwave_big" density-ablation --suite "$tmp_rust_corpus/multi-medium.json" --format json)"
...
big_memory_final_proof_medium_doctor_json="$("$llmwave_big" memory-final-proof --profile rust --artifact "$tmp_rust_corpus/rust-corpus.json" --heldout-suite "$tmp_rust_corpus/rust-heldout.json" --focus-packet "$tmp_rust_corpus/rust-focus.json" --compile-evidence "$tmp_rust_corpus/rust-compile-evidence.json" --heldout-eval "$tmp_rust_corpus/rust-heldout-eval.json" --strict-density-evidence "$tmp_rust_corpus/strict-density.json" --multi-profile-density-evidence "$tmp_rust_corpus/multi-medium.json" --density-doctor-evidence "$tmp_rust_corpus/density-doctor-medium.json" --format json)"
...
jq -e '.claim_boundary.blocked_by == ["broad_llm_eval_missing"] and .final_proof_gate.density_proof_doctor_ready == true and .final_proof_gate.density_proof_doctor_strong == false' <<<"$big_memory_final_proof_medium_doctor_json" >/dev/null
