...
enum Command {
    ...
    Doctor(DoctorArgs),
    Dogfood(DogfoodArgs),
    ContractGate(commands::contract_gate::ContractGateArgs),
    ...
    SkillReadiness(commands::skill_readiness::SkillReadinessArgs),
...
struct SearchArgs {
    ...
    #[arg(long, value_enum, default_value = "cutover")]
...
fn run() -> Result<u8> {
    ...
    match cli.command {
        ...
        Command::ContractGate(args) => commands::contract_gate::cmd(args),
        ...
        Command::SkillReadiness(args) => commands::skill_readiness::cmd(args),
