...
pub(crate) fn search_cmd(args: SearchArgs) -> Result<u8> {
    ...
    let field_engine = field_core::structural_field_engine_decision(&result, &args.field_engine);
    field_core::apply_structural_field_cutover(&mut result, &field_engine);
