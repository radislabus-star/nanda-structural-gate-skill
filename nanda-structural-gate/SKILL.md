...
scripts/nanda-llmwave-big broad-eval-run --corpus .nanda/llmwave-big-training/broad-corpus.json --suite .nanda/llmwave-big-training/broad-eval-suite.json --hot-packet .nanda/llmwave-big-training/density-ablation.hot --out .nanda/llmwave-big-training/broad-eval.json --format json
...
scripts/nanda-llmwave-big llmwave-readiness --memory-final-proof .nanda/llmwave-big-training/memory-final-proof.json --broad-eval .nanda/llmwave-big-training/broad-eval.json --baseline-duel .nanda/llmwave-big-training/broad-baseline-duel.json --out .nanda/llmwave-big-training/llmwave-readiness.json --format json
